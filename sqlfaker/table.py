...
from sqlfaker.foreign_key import ForeignKey
from sqlfaker.primary_key import PrimaryKey
from sqlfaker.functions import check_type, check_value_is_not_less_than
...
class Table:
    ...
    def add_column(self, column_name, data_type="int", not_null=False, data_target="name"):
